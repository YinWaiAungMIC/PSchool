        ...
        <div class="mt-8 bg-white rounded">
            <div class="w-full max-w-2xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <img class="w-20 h-20 sm:w-32 sm:h-32 rounded" src="{{ asset('backendtemplate/teacherImg/' .$teacher->user->profile_picture) }}" alt="avatar">
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <span class="text-gray-600 font-bold">{{ $teacher->current_address }}</span>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <span class="text-gray-600 font-bold">{{ $teacher->permanent_address }}</span>
                    </div>
                </div>
